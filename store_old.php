...
<?php $business_data = business_data_from_business_id($_GET['bid']); ?>
    ...
    <div class="container">		
		...
		<div class="row" style="margin-bottom:100px;">
				<div class="span4" style="text-align:center;">				
       	       ...
       	       <br />
            		 ...
            		 <tr>
 					 	 ...
 					 	 <tr>
               		   <td>Owner</td>
               			<td><?php echo $business_data['username'] ?></td>
            		 </tr>
                   <tr> 
               			<td>Phone</td>
				...
				<div class="span3" style="text-align:center;background-color:#fff;border-radius:10px;">
				</div>
				
				<div class="span5">
					<iframe width="100%" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.es/maps/ms?gl=ES&amp;ptab=2&amp;ie=UTF8&amp;oe=UTF8&amp;msa=0&amp;msid=211176610986848596482.00044518f8853518ca47d&amp;ll=48.851497,2.334041&amp;spn=0.039486,0.108494&amp;t=m&amp;output=embed"></iframe>
					<br /><br />
					<ul class="thumbnails">						
						<li class="span5">
						...
						<li class="span5">
							<a href="<?php echo $business_data['shopper_url']; ?>" class="btn btn-block btn-info" style="height:35px;">Download Shopper (.pdf)</a>
						</li>
					</ul>
				</div>
		</div>
